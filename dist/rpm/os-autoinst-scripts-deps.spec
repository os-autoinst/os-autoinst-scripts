...
%define main_requires bash coreutils cpio curl git-core git-lfs grep html-xml-utils iputils jq openQA-client openssh-clients osc perl >= 5.010 perl(Data::Dumper) perl(FindBin) perl(Getopt::Long) perl(Mojo::File) perl(Text::Markdown) perl(YAML::PP) python3-net-snmp python3-openqa_client python3-pynetbox python3-requests python3-sh python3-tenacity python3-typer retry sed sudo xmlstarlet yq
# The following line is generated from dependencies.yaml
