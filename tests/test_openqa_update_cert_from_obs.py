# Copyright SUSE LLC
# ruff: file-ignore[raise-vanilla-class, raise-vanilla-args, raw-string-in-exception, boolean-type-hint-positional-argument, unused-lambda-argument, unused-unpacked-variable]
